error id: file://<WORKSPACE>/controlStructures.scala:scala/Matchable#
file://<WORKSPACE>/controlStructures.scala
empty definition using pc, found symbol in pc: scala/Matchable#
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -Matchable#
	 -scala/Predef.Matchable#
offset: 2278
...
def getClassAsString(x: Matcha@@ble): String = x match
